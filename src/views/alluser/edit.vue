          ...
          <el-row :gutter="16">
            ...
            <el-col :sm="12" :md="6">
              <el-form-item label="生日">
                <el-date-picker v-model="temp.Id" type="date" placeholder="請選擇生日" style="width: 100%"></el-date-picker>
              </el-form-item>
            </el-col>
            <el-col :sm="12" :md="6">
            ...
            <el-col :sm="12" :md="6">
              <el-form-item label="額度控管留用首月">
                <el-date-picker v-model="temp.Id" type="month" style="width: 100%" placeholder="請選擇額度控管留用首月"></el-date-picker>
              </el-form-item>
            </el-col>
            <el-col :sm="24" :md="12">
                ...
                <el-row :gutter="16">
                  <el-col :sm="12" :md="6" style="margin-bottom: 1rem">
                    <el-form-item prop="city">
                      <el-select v-model="temp.city" clearable placeholder="請選擇居住縣市" style="width: 100%">
                        <el-option :value="1" :label="'可派發'">可派發</el-option>
                        <el-option :value="2" :label="'不可派發'">不可派發</el-option>
                      </el-select>
                    </el-form-item>
            ...
            <el-col :sm="24" :md="24">
              <el-form-item label="輪住地址">
                <el-row :gutter="16" v-for="(item, index) in temp.lun" :key="index" style="margin-bottom: 1rem">
                  <el-col :sm="12" :md="3" style="margin-bottom: 1rem">
                    <el-form-item>
                      <el-select v-model="item.value1" clearable placeholder="居住縣市" style="width: 100%">
                        <el-option :value="1" :label="'可派發'">可派發</el-option>
                        <el-option :value="2" :label="'不可派發'">不可派發</el-option>
                      </el-select>
                    </el-form-item>
                  ...
                  <el-col :sm="12" :md="3" style="margin-bottom: 1rem">
                    <el-form-item>
                      <el-select v-model="item.value2" clearable placeholder="居住地區" style="width: 100%">
                        <el-option :value="1" :label="'可派發'">可派發</el-option>
                        <el-option :value="2" :label="'不可派發'">不可派發</el-option>
                      </el-select>
                    </el-form-item>
